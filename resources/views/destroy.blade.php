                            ...
                            <form action="{{ route('membros.delete', $membros->id) }}" method="POST">
                                ...
                                <div>
                                    ...
                                    <input class="form-control" type="text" id="modelo" name="modelo"
                                        value="{{ $membros->CPF }}" disabled>
                                </div>
                                <div>
                                    <label for="tipo">Nome:</label>
                                    <input class="form-control " type="text" id="tipo" name="tipo"
                                        value="{{ $membros->nome }}" disabled>
                                </div>
                                <div>
                                    <label for="fabricante">ID Usuário</label>
                                    <input class="form-control" type="text" id="fabricante" name="fabricante"
                                        value="{{ $membros->id_users }}" disabled>
                                </div>
                                <br>
                                <div class="alert alert-danger" role="alert">Esta operação não poderá ser desfeita! Confirma
                                    a exclusão do equipamento?</div>
